...
using AnandAddressBookProject.Areas.LOC_Country.Models;
using AnandAddressBookProject.Areas.LOC_State.Models;
using AnandAddressBookProject.Areas.LOC_City.Models;
using AnandAddressBookProject.Areas.CON_Contact.Models;
using AnandAddressBookProject.Areas.MST_ContactCategory.Models;
using System.Data;
using System.Collections.Generic;
using System;
using System.IO;
using AnandAddressBookProject.DAL;
using AnandAddressBookProject.BAL;

namespace AnandAddressBookProject.Areas.CON_Contact.Controllers
{
    [CheckAccess]
    [Area("CON_Contact")]
